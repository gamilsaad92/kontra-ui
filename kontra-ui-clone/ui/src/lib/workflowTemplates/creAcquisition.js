...
export const roles = [
  { key: "owner",      label: "Owner / Borrower",     shortLabel: "Owner",       icon: "🏢", required: true,  needsDocs: false, invitable: false },
  { key: "lender",      label: "Lender / Underwriter", shortLabel: "Lender",      icon: "🏦", required: true,  needsDocs: true,  invitable: true,  inviteAction: "review the financial package" },
...
export const creAcquisitionTemplate = {
  id: "cre_acquisition",
...
export default creAcquisitionTemplate;
