...
const documentSchemas = {
  Multifamily: [
    ...
    { id: "rent_roll",          label: "Rent Roll",                     section: "rent_roll",          ai: true,  required: true,  assignedTo: ["owner"],      category: "Financial" },
    { id: "financials",         label: "T-12 Financial Statement",      section: "financials",         ai: true,  required: true,  assignedTo: ["owner"],      category: "Financial" },
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"],    category: "Insurance" },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"],  category: "Property / Asset" },
    { id: "estoppel",           label: "Estoppel Certificates",         section: "estoppel",           ai: true,  required: false, assignedTo: ["owner"],      category: "Legal" },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"],  category: "Operational" },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"],      category: "Property / Asset" },
    { id: "title",              label: "Title Commitment",              section: "title",              ai: true,  required: true,  assignedTo: ["attorney"],   category: "Legal" },
  ],
  Office: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"],      category: "Legal" },
    { id: "rent_roll",          label: "Rent Roll",                     section: "rent_roll",          ai: true,  required: true,  assignedTo: ["owner"],      category: "Financial" },
    ...
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"],    category: "Insurance" },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"],  category: "Property / Asset" },
    { id: "estoppel",           label: "Estoppel / Lease Abstracts",    section: "estoppel",           ai: true,  required: true,  assignedTo: ["owner"],      category: "Legal" },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"],  category: "Operational" },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"],      category: "Property / Asset" },
    { id: "title",              label: "Title Commitment",              section: "title",              ai: true,  required: true,  assignedTo: ["attorney"],   category: "Legal" },
    { id: "legal",              label: "Loan / Legal Documents",        section: "legal",              ai: true,  required: false, assignedTo: ["attorney"],   category: "Legal" },
  ],
  Industrial: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"],      category: "Legal" },
    { id: "financials",         label: "Financial Statement",           section: "financials",         ai: true,  required: true,  assignedTo: ["owner"],      category: "Financial" },
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"],    category: "Insurance" },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"],  category: "Property / Asset" },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"],  category: "Operational" },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"],      category: "Property / Asset" },
    { id: "title",              label: "Title Commitment",              section: "title",              ai: true,  required: true,  assignedTo: ["attorney"],   category: "Legal" },
    { id: "legal",              label: "Lease / Legal Documents",       section: "legal",              ai: true,  required: false, assignedTo: ["attorney"],   category: "Legal" },
  ],
  Hotel: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"],      category: "Legal" },
    { id: "brand_standards",    label: "PIP / Brand Standards",         section: "brand-standards",    ai: true,  required: true,  assignedTo: ["owner"],      category: "Closing" },
    { id: "legal",              label: "Franchise Agreement",           section: "legal",              ai: true,  required: true,  assignedTo: ["attorney"],   category: "Legal" },
    { id: "financials",         label: "STR / P&L Statement",           section: "financials",         ai: true,  required: true,  assignedTo: ["owner"],      category: "Financial" },
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"],    category: "Insurance" },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"],  category: "Property / Asset" },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"],  category: "Operational" },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"],      category: "Property / Asset" },
