...
const documentSchemas = {
  Multifamily: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "rent_roll",          label: "Rent Roll",                     section: "rent_roll",          ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "financials",         label: "T-12 Financial Statement",      section: "financials",         ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"] },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "estoppel",           label: "Estoppel Certificates",         section: "estoppel",           ai: true,  required: false, assignedTo: ["owner"] },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"] },
    { id: "title",              label: "Title Commitment",              section: "title",              ai: true,  required: true,  assignedTo: ["attorney"] },
  ],
  Office: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "rent_roll",          label: "Rent Roll",                     section: "rent_roll",          ai: true,  required: true,  assignedTo: ["owner"] },
    ...
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"] },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "estoppel",           label: "Estoppel / Lease Abstracts",    section: "estoppel",           ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"] },
    { id: "title",              label: "Title Commitment",              section: "title",              ai: true,  required: true,  assignedTo: ["attorney"] },
    { id: "legal",              label: "Loan / Legal Documents",        section: "legal",              ai: true,  required: false, assignedTo: ["attorney"] },
  ],
  Industrial: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "financials",         label: "Financial Statement",           section: "financials",         ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"] },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"] },
    { id: "title",              label: "Title Commitment",              section: "title",              ai: true,  required: true,  assignedTo: ["attorney"] },
    { id: "legal",              label: "Lease / Legal Documents",       section: "legal",              ai: true,  required: false, assignedTo: ["attorney"] },
  ],
  Hotel: [
    { id: "purchase_agreement", label: "Purchase Agreement",            section: "purchase_agreement", ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "brand_standards",    label: "PIP / Brand Standards",         section: "brand-standards",    ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "legal",              label: "Franchise Agreement",           section: "legal",              ai: true,  required: true,  assignedTo: ["attorney"] },
    { id: "financials",         label: "STR / P&L Statement",           section: "financials",         ai: true,  required: true,  assignedTo: ["owner"] },
    { id: "insurance",          label: "Insurance Certificate",         section: "insurance",          ai: true,  required: true,  assignedTo: ["insurer"] },
    { id: "inspection",         label: "Property Inspection Report",    section: "inspection",         ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "environmental",      label: "Environmental Report (Phase I)",section: "environmental",      ai: true,  required: true,  assignedTo: ["inspector"] },
    { id: "survey",             label: "Survey / ALTA",                 section: "survey",             ai: true,  required: false, assignedTo: ["owner"] },
