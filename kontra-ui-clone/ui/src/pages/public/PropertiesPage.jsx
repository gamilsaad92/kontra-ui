...
const PROPERTIES = [
  ...
  { id: "summit-industrial",  name: "Summit Industrial Park", type: "Industrial",  city: "Atlanta",     state: "GA", units: null, sf: 145000, occupancy: 100, risk: "Low",    riskColor: "#16a34a", score: 91, inspection: "Passed",   market: "Atlanta",   yearBuilt: 2015, digitalStatus: "Readiness Summary", image: "https://images.unsplash.com/photo-1565043589221-1a6fd9ae45c7?w=600&q=70" },
  { id: "harbor-view",        name: "Harbor View Apartments", type: "Multifamily", city: "Miami",       state: "FL", units: 312,  sf: null,    occupancy: 97,  risk: "Low",    riskColor: "#16a34a", score: 93, inspection: "Passed",   market: "South FL",  yearBuilt: 2020, digitalStatus: "Readiness Summary", image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=600&q=70" },
  ...
  { id: "lakeshore-logistics",name: "Lakeshore Logistics Hub",type: "Industrial",  city: "Columbus",    state: "OH", units: null, sf: 290000, occupancy: 98,  risk: "Low",    riskColor: "#16a34a", score: 95, inspection: "Passed",   market: "Columbus",  yearBuilt: 2021, digitalStatus: "Readiness Summary", image: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=600&q=70" },
...
const DIGITAL_STATUS = {
  "Readiness Summary": { label: "Readiness Summary", color: "#92400e", bg: "#fffbeb", dot: "#f59e0b" },
  "Verified":          { label: "Source Review",      color: "#065f46", bg: "#f0fdf4", dot: "#16a34a" },
