    ...
    <PublicLayout>
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-10">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Service Provider Directory</h1>
          <p className="text-sm text-gray-500">Browse illustrative inspector, engineer, property manager, and other service-provider listings for deal-room planning.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <label className="flex items-center gap-2 text-sm text-gray-600 cursor-pointer bg-white border border-gray-200 rounded-xl px-4 py-2.5">
            ...
            Show sample verification flags
          </label>
        </div>

        <div className="mb-5 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-relaxed text-amber-800">
          Sample directory: the names, locations, ratings, reviews, and verification flags below are illustrative and are not verified production listings or endorsements.
        </div>
        <p className="text-xs text-gray-400 mb-5">{filtered.length} sample listings</p>
          ...
          {filtered.map((p) => (
            <div key={p.id} className="bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all p-5">
              ...
              <div className="mb-3">
                ...
                <p className="text-xs text-gray-400 mt-0.5">Sample rating · {p.reviews} sample reviews</p>
              </div>
        ...
        <div className="mt-12 bg-gray-50 rounded-2xl border border-gray-200 p-8 text-center">
          <h3 className="text-lg font-bold text-gray-900 mb-2">Want to be considered for a listing?</h3>
          <p className="text-sm text-gray-500 mb-4 max-w-sm mx-auto">Contact Kontra about a future provider directory. Listing availability, verification, and introductions are not currently guaranteed.</p>
          <Link to="/waitlist"
