      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4">
        <div className="max-w-xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">Your transaction coordination deal room — every party, stage, and deadline in one place.</p>
          </div>
                ...
                {creationMode !== "blank" && (
                  <label className="flex items-start gap-2.5 rounded-xl border border-gray-200 bg-white px-3.5 py-3 cursor-pointer">
                    ...
                    <span className="text-xs text-gray-600 leading-relaxed">
                      ...
                      {isAiGenerated
                        ? " I approve this AI-generated configuration for the deal room."
                        : " I approve this configuration for the deal room."}
                    </span>
                  </label>
                )}
          ...
          {phase === 3 ? (
            ...
            <div className="space-y-3">
              <button type="button" onClick={() => handleLaunch(false)} disabled={loading}
                ...
                ) : "🔐 Pay $499 and Activate Deal Room"}
              </button>
