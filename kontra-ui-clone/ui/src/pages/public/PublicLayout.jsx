...
export default function PublicLayout({ children, hideFooter = false, dealRoomMode = false, dealRoomTitle = "" }) {
        ...
        {dealRoomMode ? (
          <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between gap-4">
            <Link to="/my-deal-rooms"
              className="flex items-center gap-1.5 text-sm font-medium text-gray-500 hover:text-gray-900 transition shrink-0">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
              My Deal Rooms
            </Link>
            <span className="font-semibold text-sm text-gray-900 truncate text-center flex-1 px-4">{dealRoomTitle}</span>
