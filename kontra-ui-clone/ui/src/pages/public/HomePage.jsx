      ...
      <section id="how-it-works" className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-sm max-w-xl mx-auto leading-relaxed">
             Describe your transaction, invite your parties, and let Kontra coordinate the next steps from there.
          </p>
        </div>
      ...
      <section className="bg-gray-950 py-16 text-center">
        <div className="max-w-xl mx-auto px-6">
          ...
          <p className="text-gray-400 text-sm mb-8 leading-relaxed">
             $499 one-time. Includes participants, document coordination, AI-assisted review, and an audit trail for material activity.
          </p>
