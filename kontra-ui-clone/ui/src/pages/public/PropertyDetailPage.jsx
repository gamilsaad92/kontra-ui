...
/* Auth-aware action button — redirects to login with intent params if logged out */
function ActionButton({ propertyId, action, label, href, className = "", style = {} }) {
  ...
  const handleClick = () => {
    if (session) {
      ...
      navigate(`/login?redirect=${encodeURIComponent(href)}&action=${action}&propertyId=${propertyId}`);
    }
  };
  return <button onClick={handleClick} className={className} style={style}>{label}</button>;
}

/* Locked workspace section — shows open button when logged in, sign-in gate when not */
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-end justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <ActionButton propertyId={property.id} action="claim" label="Claim Property" href="/app/properties"
              ...
              <div className="space-y-6">
                ...
                {!session && (
                  <div className="rounded-2xl p-6 text-center" style={{ background: "#f8f4f4", border: "1px solid #f0e4e4" }}>
                    ...
                    <button onClick={() => navigate(`/login?redirect=/app/properties&action=watchlist&propertyId=${property.id}`)}
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              ...
              <div className="h-2 rounded-full bg-gray-100 overflow-hidden mb-2">
                <div className="h-full rounded-full" style={{ width: `${property.score}%`, background: property.riskColor }} />
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              ...
              <div className="space-y-2">
                ...
                <ActionButton propertyId={property.id} action="inspection" label="Request Inspection"
                ...
                <ActionButton propertyId={property.id} action="documents" label="Upload Documents"
                  href="/app/documents"
