...
const STEPS = [
  {
    ...
    actions: [
      ...
      "Deal room can be configured quickly",
    ],
    visual: [
  ...
  },
  {
    ...
    desc: "Send each participant a role-scoped invite link — no account required for invited participants. Access is scoped to the role and workflow permissions, and uploads are routed to the configured checklist.",
    actions: [
  ...
  },
  {
    ...
    desc: "Uploaded documents can be analyzed by the configured AI service. The AI Operations Manager surfaces blockers, tracks the critical path, and drafts follow-up messages — you decide what to send.",
    actions: [
  ...
  },
  {
    ...
    actions: [
      ...
      "Key checklist status visible before closing",
      "Audit log for material actions, AI recommendations, and approvals",
        ...
        <div className="rounded-3xl bg-gray-950 p-10 md:p-14 text-white text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left max-w-3xl mx-auto">
            {[
              ...
              { icon: "📊", title: "Daily Standup", desc: "End-of-day summary of recent actions, completed tasks, and flags across the deal room." },
