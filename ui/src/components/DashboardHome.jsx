...
const Pill = ({ children, tone = "gray" }) => {
  ...
  return (
    <span className={`inline-flex items-center px-2 py-0.5 text-xs font-medium rounded border ${tones[tone]}`}>
      {children}
    </span>
  );
};
...
export default function DashboardHome() {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-12 gap-6">
        <Card title="Customer Communications" className="col-span-12 lg:col-span-4">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr>
                <td className="py-2">04/22/2024</td>
                <td>Email</td>
                <td><Pill>Sent</Pill></td>
              </tr>
              <tr>
                <td className="py-2">04/21/2024</td>
                <td>SMS</td>
                <td><Pill tone="green">Delivered</Pill></td>
              </tr>
              <tr>
                <td className="py-2">04/20/2024</td>
                <td>Push Tietjulfs</td>
                <td><Pill tone="amber">Alert</Pill></td>
              </tr>
            </tbody>
          </table>
        </Card>
        ...
        <Card title="Hyperautomation Workflows" className="col-span-12 lg:col-span-4">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr>
                <td className="py-2">Summarize Document</td>
                <td><Pill tone="green">Completed</Pill></td>
              </tr>
              <tr>
                <td className="py-2">Sync Records</td>
                <td><Pill tone="green">Completed</Pill></td>
              </tr>
              <tr>
                <td className="py-2">Transfer Records</td>
                <td><Pill tone="sky">In Progress</Pill></td>
              </tr>
            </tbody>
          </table>
        </Card>
        ...
        <Card title="Asset Management" className="col-span-12 lg:col-span-4">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr>
                <td className="py-2">Asset 123</td>
                <td>Troubled</td>
                <td><Pill>Upstaked</Pill></td>
              </tr>
              <tr>
                <td className="py-2">Asset 458</td>
                <td>AI Summary</td>
                <td><Pill>Uploaded</Pill></td>
              </tr>
              <tr>
                <td className="py-2">Asset 789</td>
                <td>Revived</td>
                <td><Pill>$595,000</Pill></td>
              </tr>
            </tbody>
          </table>
        </Card>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr>
                <td className="py-2">04/22/2024</td>
                <td>+1-555-0134</td>
                <td><Pill tone="red">Churn</Pill></td>
              </tr>
              <tr>
                <td className="py-2">04/20/2024</td>
                <td>+1-585-0275</td>
                <td><Pill>Support Request</Pill></td>
              </tr>
            </tbody>
          </table>
        </Card>
        ...
        <Card title="Voice Bot" className="col-span-12 lg:col-span-4">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              <tr>
                <td className="py-2">04/15/2024</td>
                <td>+1-555-0312</td>
                <td>—</td>
              </tr>
            </tbody>
      ...
      {/* Row 4 (wide Asset Management + tall Voice Bot) */}
      <div className="grid grid-cols-12 gap-6">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-slate-500">
                <th className="py-2">Asset</th>
                <th className="py-2">Risk</th>
                <th className="py-2">Inspection File</th>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr>
                <td className="py-2">Asset 123</td>
                <td>Troubled</td>
                <td><Pill>AI summary uploaded</Pill></td>
                <td>—</td>
              </tr>
              <tr>
                <td className="py-2">Asset 456</td>
                <td>Revived</td>
                <td><Pill>AI summary uploaded</Pill></td>
                <td>—</td>
              </tr>
