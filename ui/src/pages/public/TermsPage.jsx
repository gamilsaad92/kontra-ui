...
// ── PLACEHOLDER: Replace [KONTRA PLATFORM LLC] with the official LLC name once formed.
...
const SECTIONS = [
  ...
  },
  {
     ...
     content: "A paid deal room remains active until it is closed by the owner, terminated under these Terms, or discontinued following notice under the applicable purchase terms. Deal room data is retained for the duration of the active deal room. Following deal room closure or account termination, data is retained for up to 30 days to allow export requests, after which it is deleted. Deleted data may remain in encrypted backups for a limited period until those backups are overwritten in the ordinary course and will not be restored except for disaster recovery or legal obligations. Customers requiring longer retention for legal, contractual, or compliance reasons may contact support@kontraplatform.com — subject to a written agreement.",
  },
  {
    title: "14. Your Responsibility to Export Records",
     content: "Kontra is a deal room tool, not an official books-and-records repository. Before closing or terminating a deal room, you are responsible for exporting any records you need for your own compliance, tax, legal, or business purposes. Kontra is not liable for any records you fail to export before the end of the 30-day post-termination retention window. Customers are responsible for verifying exported records before relying on them for legal, accounting, regulatory, or archival purposes. Deal room data exports are available in PDF, ZIP, and JSON formats upon request to support@kontraplatform.com.",
  },
  {
    title: "15. Intellectual Property",
    content: "The Kontra platform, brand, design, software, proprietary prompts, workflow logic, configurations, interfaces, and analysis methods are owned by Kontra Platform LLC and protected by applicable intellectual property laws. You may not copy, modify, or distribute any part of the platform without written consent. These terms do not grant you any rights to our trademarks or trade names.",
  },
  {
  ...
  },
  {
    ...
    content: "You agree to defend and indemnify Kontra Platform LLC and its personnel and agents from and against any claims, damages, or expenses (including legal fees) arising from: (a) your use of the platform; (b) your violation of these terms; (c) your violation of any third party's rights; (d) any content you upload that infringes third-party rights; or (e) any securities or regulatory violation arising from your use of the Fundraising or tokenization features.",
  },
  {
    title: "19. Assignment",
    content: "You may not assign or transfer your rights or obligations under these terms without Kontra's prior written consent. Kontra Platform LLC may assign or transfer these terms, in whole or in part, without restriction, including in connection with a merger, acquisition, corporate reorganization, or sale of all or substantially all of its assets. Any attempted assignment in violation of this section is void.",
  },
  {
    title: "20. Survival",
  ...
  },
  {
    ...
    content: "You may terminate your account at any time by contacting support@kontraplatform.com. We may suspend or terminate your account for material breach of these terms, with or without notice depending on severity. Upon termination, your access to the deal room ceases immediately. We will retain your data for up to 30 days following termination, during which you may request an export.",
  },
  {
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-600 mt-4 leading-relaxed">
            These Terms of Service govern your use of Kontra's platform and services operated by Kontra Platform LLC. Please read them carefully.
          </p>
        </div>
