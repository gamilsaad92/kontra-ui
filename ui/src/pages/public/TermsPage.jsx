...
const SECTIONS = [
  ...
  {
    title: "12. Workspace Purchases and Billing",
  ...
  {
    title: "13. Workspace Duration and Retention",
  ...
  },
  {
    ...
    content: "Kontra is a transaction workspace tool, not an official books-and-records repository. Before closing or terminating a workspace, you are responsible for exporting any records you need for your own compliance, tax, legal, or business purposes. Kontra is not liable for any records you fail to export before the end of the 30-day post-termination retention window. Customers are responsible for verifying exported records before relying on them for legal, accounting, regulatory, or archival purposes. Workspace data exports are available in PDF, ZIP, and JSON formats upon request to support@kontraplatform.com.",
  },
  {
