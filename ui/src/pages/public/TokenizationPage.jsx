      ...
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="max-w-md mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            This page has moved. Kontra is an AI transaction workspace — helping all parties close deals faster with structured, verified data.
          </p>
          <div className="flex flex-col gap-2">
            <Link to="/how-it-works"
              className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition hover:opacity-90"
              style={{ background: "#800020" }}>
              See how workspaces work →
            </Link>
