          ...
          {options.map(option => (
            <div key={`${option.label}-${option.value}`} className={`rounded-xl border p-3 ${option.primary ? 'border-[#800020]/30 bg-[#800020]/5' : 'border-gray-200 bg-gray-50'}`}>
              ...
              <button
                ...
                disabled={saving}
                className={`mt-3 w-full rounded-lg px-3 py-2 text-[11px] font-bold disabled:opacity-50 ${option.primary ? 'bg-[#800020] text-white' : 'border border-gray-300 bg-white text-gray-700'}`}
              >
