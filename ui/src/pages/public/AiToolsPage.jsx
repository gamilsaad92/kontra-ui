    ...
    <div className="bg-gray-950 rounded-xl p-4 font-mono text-xs mb-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-gray-500 text-xs">
          {status === "loading" ? "Analyzing with the configured AI service…" : isReal ? "✓ AI Analysis Complete" : "Sample Output"}
        </span>
      ...
      <div className="bg-gradient-to-b from-gray-950 to-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 text-sm max-w-xl mx-auto leading-relaxed">
            Upload a document for AI-assisted analysis. Inspection reports, insurance policies, and financial statements are supported subject to the current product configuration.
          </p>
        </div>
      </div>
