...
const DEAL_FEATURES = [
  ...
  "Access during the applicable active deal-room period",
];

const ENTERPRISE_FEATURES = [
  "Everything in a Deal Room",
  "Multiple deal rooms under one account",
  "Lender & underwriter dashboard",
  "Volume pricing available",
  "Security and data-processing discussions by agreement",
];

const FAQS = [
  {
    q: "What counts as a deal room?",
    a: "One deal room = one transaction. Each deal room holds all parties, all documents, and all AI analysis for that deal. Pay once, use it for the life of the transaction.",
  },
  {
    q: "Who can access the deal room?",
    a: "Anyone you invite. Owner, counterparty, advisor, lender, attorney, underwriter — each gets a role-scoped link to the same deal room. No account creation required for invited parties.",
  },
  {
    q: "What documents does AI analyze?",
    a: "Inspection reports, insurance policies, financial statements, legal documents, and other supported transaction materials. Available analysis depends on the document and current product configuration.",
  },
  {
  ...
  {
    q: "Is my data secure?",
    a: "Kontra uses application and provider-level controls described on the Security page, including encrypted transport, configured storage protections, scoped access controls, and time-limited document links. No security control eliminates every risk.",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 text-base max-w-md mx-auto leading-relaxed">
            Complex transactions shouldn't require 700 emails.
             Create a deal room and coordinate every step to closing.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl border-2 p-8 relative shadow-lg" style={{ borderColor: "#800020" }}>
            ...
            <div className="mb-2">
              <h2 className="text-xl font-bold text-gray-900">Create Deal Room</h2>
            ...
            <div className="my-6 pb-6 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-2">One-time · Active deal-room access · No credit card at signup</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 flex flex-col">
            ...
            <div className="my-6 pb-6 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-2">Multiple deal rooms · Volume pricing · Contract terms may vary</p>
            </div>
