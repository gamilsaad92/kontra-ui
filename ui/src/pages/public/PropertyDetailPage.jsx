...
const DIGITAL_STATUS_MAP = {
  ...
  "summit-industrial":   "Readiness Summary",
  "harbor-view":         "Readiness Summary",
  "oakwood-plaza":       "Unclaimed",
  "northgate-retail":    "Claimed",
  "riverside-mixed":     "Verified",
  "pinecrest-garden":    "Claimed",
  "lakeshore-logistics": "Readiness Summary",
...
const DIGITAL_STATUS_CFG = {
  "Readiness Summary": { label: "Readiness Summary", color: "#92400e", bg: "#fffbeb", dot: "#f59e0b", desc: "A sample summary of available property and transaction information; it is not an investment recommendation or eligibility determination." },
  "Verified":         { label: "Source Review",     color: "#065f46", bg: "#f0fdf4", dot: "#16a34a", desc: "Selected documents or ownership claims are marked as reviewed in this sample property record." },
  "Claimed":          { label: "Claimed",            color: "#1e3a8a", bg: "#eff6ff", dot: "#3b82f6", desc: "Property claimed by an owner in this sample property record." },
            ...
            <div className="flex items-end justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button onClick={handleClaim} disabled={claimState === "claiming"}
                  ...
                  {claimState === "claimed" && "✓ View in Deal Room →"}
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {activeTab === "Inspections" && (
              <WorkspaceGate propertyId={property.id} action="inspection" label="Inspection Reports"
                description="Access inspection history, findings, and remediation status. Any service-provider request is subject to availability and separate verification."
                icon="🔍" />
            )}
            {activeTab === "Documents" && (
              <WorkspaceGate propertyId={property.id} action="documents" label="Document Deal Room"
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              ...
              <p className="text-xs text-gray-500 mb-4">Access the deal room to analyze documents, track review items, and coordinate with participants.</p>
