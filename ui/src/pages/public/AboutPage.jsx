      ...
      <section className="bg-gray-950 text-white py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-xl mx-auto">
            Kontra is deal room infrastructure. We make it possible for every party on a deal — lender, borrower, inspector, insurer, attorney, buyer, seller — to work from the same verified data, in real time, without email chains.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-4">
              Kontra is a young company based in Pasadena, California. We're not a marketplace, we're not a brokerage, and we're not trying to tokenize your property. We're building deal room infrastructure — the coordination layer that every complex deal needs but nobody has built well.
            </p>
            <p className="text-gray-500 leading-relaxed">
              We're live, accepting deals, and actively talking to lenders, borrowers, business buyers, and service providers. If you're working on a complex transaction and want to keep every party aligned through closing, we'd love to show you what a Kontra deal room looks like on your deal.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Deal room infrastructure — pure SaaS, no brokering</p>
              </div>
            </div>
          </div>
        </div>
