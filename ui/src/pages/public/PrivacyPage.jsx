...
const SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      "**Document retrieval**: Store original uploaded documents so they remain accessible to authorized deal room participants during the applicable active period.",
  ...
  },
  {
    ...
    content: [
      "Kontra may use one or more third-party AI providers to process document text and generate analysis. The provider and processing terms can change; the current provider disclosure is maintained here.",
      "**OpenAI**: When configured for a deal room analysis, document text may be sent to OpenAI's API. OpenAI's use of API inputs and outputs is governed by the applicable endpoint and provider terms. See openai.com/policies.",
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-10 p-5 rounded-xl border border-gray-200 bg-gray-50">
          ...
          <div className="space-y-2">
            {[
               "📄  Uploaded documents are stored in configured cloud storage during the applicable active deal-room period.",
               "🤖  Document text may be sent to a third-party AI provider at analysis time. Current provider disclosure: OpenAI.",
              ...
              "📋  Material AI recommendations, task actions, and approvals are recorded in a deal room audit log.",
               "🗑️  Retention and deletion timing depends on the deal room, product configuration, applicable law, legal holds, and written agreements.",
            ].map((fact, i) => (
