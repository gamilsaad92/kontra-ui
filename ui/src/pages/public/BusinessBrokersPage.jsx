    ...
    <div className="bg-gray-900 rounded-2xl overflow-hidden border border-gray-700 shadow-2xl">
      ...
      <div className="bg-gray-950 border-b border-gray-800 px-5 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-blue-900/50 text-blue-300">Deal Room Active</span>
...
const OUTCOMES = [
  ...
  },
  {
    ...
    desc: "Document submissions, approvals, and stage changes can be timestamped. At closing, the deal room keeps a record of the activity available to the parties.",
    color: "#065f46",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-0">
          ...
          <div className="text-center max-w-4xl mx-auto mb-8">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-5 leading-relaxed">
              Kontra gives each M&A deal its own coordinated deal room — buyer, seller, CPA, and attorney all in one place. Your AI Operations Manager tracks documents, surfaces blockers, and keeps the transaction moving.
            </p>
      ...
      <section className="bg-gray-950 py-14">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl font-bold text-white mb-3">Your deal room, configured in minutes.</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 leading-snug">
              Documents, parties, and deadlines — coordinated in one place.
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              ...
              { value: "Active period",   label: "Access through closing" },
            ].map(s => (
              <div key={s.label}>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="space-y-4">
          {[
            ...
            {
              q: "I run 8–10 deals at once. Do I need a separate deal room for each?",
