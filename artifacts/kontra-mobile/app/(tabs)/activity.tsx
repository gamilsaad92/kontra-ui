...
const INVESTOR_ITEMS: ActivityItem[] = [
  ...
  { id: "6", type: "document", title: "Annual Tax Statement", subtitle: "Form 1099 · 2025", date: "Jan 31, 2026", read: true },
...
const BORROWER_ITEMS: ActivityItem[] = [
  ...
  { id: "6", type: "document", title: "Loan Statement", subtitle: "Q1 2026", date: "Feb 1, 2026", read: true },
];
...
export default function ActivityScreen() {
  ...
  return (
    ...
    >
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
        {FILTERS.map((f) => (
          <TouchableOpacity
            ...
            style={[
              styles.chip,
              { backgroundColor: filter === f ? accentColor : colors.secondary, borderColor: filter === f ? accentColor : colors.border },
            ]}
            activeOpacity={0.8}
          >
      ...
      <Text style={[styles.countLabel, { color: colors.mutedForeground }]}>{items.length} events</Text>
                ...
                <View style={styles.row}>
                  ...
                  {item.amount && (
                    <Text
                      style={[
                        styles.amount,
                        { color: item.amount.startsWith("+") ? colors.success : colors.destructive },
                      ]}
                    >
                      {item.amount}
                    </Text>
