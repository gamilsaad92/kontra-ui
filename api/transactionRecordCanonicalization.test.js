...
describe('Transaction Record canonicalization', () => {
  test.each([
    ...
    ['transaction.scheduled_purchase_price', 'transaction.value', 'business_acquisition'],
    ['financial.transaction_value', 'transaction.value', 'business_acquisition'],
    ['parties.seller_entity', 'parties.seller', 'business_acquisition'],
    ['parties.buyer_name', 'parties.buyer', 'business_acquisition'],
